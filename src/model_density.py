...
last_purchase_timestamp = density_data[["buyer_id","timestamp"]][density_data["event"]=="project_win"].groupby("buyer_id").last().reset_index()
...
density_data_cleaned = density_data[~(density_data["event"]=="project_win")]
density_data_cleaned = density_data_cleaned[~((density_data_cleaned["event"]=="store")& (density_data_cleaned["timestamp_difference"]==timedelta(minutes=0)))]
